...
using SneakersUIDemo.Models;
using SneakersUIDemo.Views;
using Xamarin.Essentials;
using Xamarin.Forms;

namespace SneakersUIDemo.ViewModels
{
    public class SneakersViewModel
    {
        ...
        {
            await Application.Current.MainPage.Navigation.PushAsync(new SneakersDetailsView());
        });
